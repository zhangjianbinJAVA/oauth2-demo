...
public class SecurityOauth2ClientTest {
    ...
    //clientId
    final static String CLIENT_ID = "client_1";
    //clientSecret
    final static String CLIENT_SECRET = "123456";


    //获取accessToken 的URI
    final static String TOKEN_REQUEST_URI = "http://localhost:" + PORT + "/oauth/token?grant_type=client_credentials&username=" + "&scope=select";
